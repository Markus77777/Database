...
-- 正在傾印表格  onlineshop.brand 的資料：~4 rows (近似值)
DELETE FROM `brand`;
...
INSERT INTO `item` (`i_id`, `i_name`, `i_price`, `i_quantity`, `b_id`, `t_id`, `i_pict`, `description`) VALUES
	(1, 'NIKE METCON 8', 7999, 45, 1, 1, 'https://static.nike.com.hk/resources/product/DO9328-700/DO9328-700_BL1.png', '你們為達目標、為求成長，不斷追著時間跑，並且挑戰自我，相互勉勵。 這款必備訓練鞋型採用較先前版本更輕盈透氣的鞋面設計，讓原已達標的舒適耐穿度更上一層，無論是心肺訓練、舉重或其他健身運動，都能得心應手。'),
	(2, 'NIKE ZOOM SUPERREP 4 NN', 9999, 32, 1, 1, 'https://static.nike.com.hk/resources/product/DO9837-100/DO9837-100_BL1.png', '動起四頭肌，專注於跳箱訓練。 超級組訓練讓你汗水淋漓。 這就是你生活的意義：掙扎、關鍵時刻、突破、轉變。 Nike Zoom SuperRep 4 NN 女子高強度訓練鞋專為疾速爆發力、心跳加速的變速訓練及快節奏運動設計，讓你突破 HIIT 的全新境界。'),
	...
	(9, 'Nike Dri-FIT One', 880, 85, 1, 2, 'https://static.nike.com/a/images/t_PDP_864_v1/f_auto,b_rgb:f5f5f5/6b61cdf9-e198-4e2d-8e1d-e263579621a4/dri-fit-one-%E6%A8%99%E6%BA%96%E5%89%AA%E8%A3%81%E7%9F%AD%E8%A2%96%E4%B8%8A%E8%A1%A3-vMPqml.png', '這款上衣輕盈透氣，是你跑步時的理想良伴。 排汗材質搭配易穿剪裁，讓你在加速衝刺時也能保持涼爽。'),
...
INSERT INTO `record` (`r_id`, `item_id`, `quantity`, `cus_id`, `r_price`, `r_time`) VALUES
	(1, 15, 1, 1, 5000, '2023-06-12 06:36:34'),
	(2, 45, 2, 1, 8000, '2023-06-12 06:36:40');
